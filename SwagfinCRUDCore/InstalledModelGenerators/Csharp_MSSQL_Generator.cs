...
{
    class Csharp_MSSQL_Generator : ILanguageModelGenerator
    {
        ...
        public string Get_GeneratedModel(TableDesign CurrentTableWithColumns, string ModelNameSpace = "swagfin.Models")
        {
            ...
            try
            {
                ...
                IMPORTS_STRING += "using System.Data.SqlClient;" + Environment.NewLine;
        ...
        public string Generate_CREATE(TableDesign TableData)
        {
            ...
            try
            {
                ...
                string MYSQL_COMMAND_PARAMS = "SqlCommand Command = new SqlCommand(Sql," + TableData.Db_connvariable + ");";
        ...
        public string Generate_DELETE(TableDesign TableData)
        {
            ...
            try
            {
                ...
                // #Execution
                FINALE_CREATE_STRING += Environment.NewLine + TableData.Db_connvariable + ".Open();";
                FINALE_CREATE_STRING += Environment.NewLine + "SqlCommand Command = new SqlCommand(Sql," + TableData.Db_connvariable + ");";
        ...
        public string Generate_GET(TableDesign TableData)
        {
            ...
            try
            {
                ...
                FINALE_CREATE_STRING += Environment.NewLine + "SqlDataReader feedback = Command.ExecuteReader();";
                // #Fetch Details
        ...
        public string Generate_READ(TableDesign TableData)
        {
            ...
            try
            {
                ...
                FINALE_CREATE_STRING += Environment.NewLine + "SqlDataAdapter my_adapter = new SqlDataAdapter(Command);";
