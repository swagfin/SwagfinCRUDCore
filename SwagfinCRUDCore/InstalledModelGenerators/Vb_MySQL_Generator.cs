...
{
    class Vb_MySQL_Generator : ILanguageModelGenerator
    {
        ...
        public string Get_GeneratedModel(TableDesign CurrentTableWithColumns, string ModelNameSpace = "swagfin.Models")
        {
            ...
            try
            {
                ...
                // #Determine Imports
                IMPORTS_STRING = "Imports MySql.Data.MySqlClient";
                ...
                ALLTEXT += Environment.NewLine + "Protected " + CurrentTableWithColumns.Db_connvariable + " As MySqlConnection  = New MySqlConnection(" + QuotesChar + "server=localhost;userid=root;password=;port=3306;database=" + CurrentTableWithColumns.Database_Name + QuotesChar + ")";
        ...
        public string Generate_CREATE(TableDesign TableData)
        {
            ...
            try
            {
                ...
                string MYSQL_COMMAND_PARAMS = "Dim Command As New MySqlCommand(Sql," + TableData.Db_connvariable + ")";
        ...
        public string Generate_DELETE(TableDesign TableData)
        {
            ...
            try
            {
                ...
                // #Execution
                FINALE_CREATE_STRING += Environment.NewLine + TableData.Db_connvariable + ".Open()";
                FINALE_CREATE_STRING += Environment.NewLine + "Dim Command As New MySqlCommand(Sql," + TableData.Db_connvariable + ")";
        ...
        public string Generate_GET(TableDesign TableData)
        {
            ...
            try
            {
                ...
                FINALE_CREATE_STRING += Environment.NewLine + "Dim feedback As MySqlDataReader = Command.ExecuteReader()";
                // #Fetch Details
        ...
        public string Generate_READ(TableDesign TableData)
        {
            ...
            try
            {
                ...
                FINALE_CREATE_STRING += Environment.NewLine + "Dim my_adapter As New MySqlDataAdapter(Command)";
