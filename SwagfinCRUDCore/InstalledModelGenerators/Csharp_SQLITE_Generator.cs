...
{
    class Vb_SQLITE_Generator : ILanguageModelGenerator
    {
        ...
        public string Get_GeneratedModel(TableDesign CurrentTableWithColumns, string ModelNameSpace = "swagfin.Models")
        {
            ...
            try
            {
                ...
                IMPORTS_STRING += "using System.Data.SQLite;" + Environment.NewLine;
                ...
                ALLTEXT += Environment.NewLine + "protected  SQLiteConnection " + CurrentTableWithColumns.Db_connvariable + " = new SQLiteConnection(" + QuotesChar + "Data Source=" + CurrentTableWithColumns.Database_Name + ".db" + QuotesChar + ");";
        ...
        public string Generate_CREATE(TableDesign TableData)
        {
            ...
            try
            {
                ...
                string MYSQL_COMMAND_PARAMS = "SQLiteCommand Command = new SQLiteCommand(Sql," + TableData.Db_connvariable + ");";
        ...
        public string Generate_DELETE(TableDesign TableData)
        {
            ...
            try
            {
                ...
                // #Execution
                FINALE_CREATE_STRING += Environment.NewLine + TableData.Db_connvariable + ".Open();";
                FINALE_CREATE_STRING += Environment.NewLine + "SQLiteCommand Command = new SQLiteCommand(Sql," + TableData.Db_connvariable + ");";
        ...
        public string Generate_GET(TableDesign TableData)
        {
            ...
            try
            {
                ...
                FINALE_CREATE_STRING += Environment.NewLine + "SQLiteDataReader feedback = Command.ExecuteReader();";
                // #Fetch Details
        ...
        public string Generate_READ(TableDesign TableData)
        {
            ...
            try
            {
                ...
                FINALE_CREATE_STRING += Environment.NewLine + "SQLiteDataAdapter my_adapter = new SQLiteDataAdapter(Command);";
        ...
        public bool Load_TableColumn_Drivers(ref TableColumn TableColumn)
        {
            try
            {
                ...
                if (TableColumn.Data_type == "int")
                {
                    ...
                    TableColumn.Column_datatype_driver = "System.Data.DbType.Int32";
                ...
                else if (TableColumn.Data_type == "double")
                {
                    ...
                    TableColumn.Column_datatype_driver = "System.Data.DbType.Double";
                }
                else if (TableColumn.Data_type == "decimal")
                {
                    TableColumn.Column_datatype_ide = "decimal";
                    TableColumn.Column_datatype_get = "GetDecimal";
                    TableColumn.Column_datatype_driver = "System.Data.DbType.Decimal";
                ...
                else if (TableColumn.Data_type == "date" | TableColumn.Data_type == "year")
                {
                    TableColumn.Column_datatype_ide = "DateTime";
                    TableColumn.Column_datatype_get = "GetDateTime";
                    TableColumn.Column_datatype_driver = "System.Data.DbType.DateTime";
                ...
                else
                {
                    ...
                    TableColumn.Column_datatype_driver = "System.Data.DbType.String";
