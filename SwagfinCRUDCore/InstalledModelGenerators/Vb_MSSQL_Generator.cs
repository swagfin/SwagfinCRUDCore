...
{
    class Vb_MSSQL_Generator : ILanguageModelGenerator
    {
        ...
        public string Get_GeneratedModel(TableDesign CurrentTableWithColumns, string ModelNameSpace = "swagfin.Models")
        {
            ...
            try
            {
                ...
                // #Determine Imports
                IMPORTS_STRING = "Imports System.Data.SqlClient";
                ...
                ALLTEXT += Environment.NewLine + "Protected " + CurrentTableWithColumns.Db_connvariable + " As SqlConnection  = New SqlConnection(" + QuotesChar + "Data Source=127.0.0.1;Initial Catalog=" + CurrentTableWithColumns.Database_Name + ";Integrated Security=True" + QuotesChar + ")";
        ...
        public string Generate_CREATE(TableDesign TableData)
        {
            ...
            try
            {
                ...
                string MYSQL_COMMAND_PARAMS = "Dim Command As New SqlCommand(Sql," + TableData.Db_connvariable + ")";
        ...
        public string Generate_DELETE(TableDesign TableData)
        {
            ...
            try
            {
                ...
                // #Execution
                FINALE_CREATE_STRING += Environment.NewLine + TableData.Db_connvariable + ".Open()";
                FINALE_CREATE_STRING += Environment.NewLine + "Dim Command As New SqlCommand(Sql," + TableData.Db_connvariable + ")";
        ...
        public string Generate_GET(TableDesign TableData)
        {
            ...
            try
            {
                ...
                FINALE_CREATE_STRING += Environment.NewLine + "Dim feedback As SqlDataReader = Command.ExecuteReader()";
                // #Fetch Details
        ...
        public string Generate_READ(TableDesign TableData)
        {
            ...
            try
            {
                ...
                FINALE_CREATE_STRING += Environment.NewLine + "Dim my_adapter As New SqlDataAdapter(Command)";
        ...
        public bool Load_TableColumn_Drivers(ref TableColumn TableColumn)
        {
            try
            {
                if (TableColumn.Data_type == "int" || TableColumn.Data_type == "tinyint" || TableColumn.Data_type == "smallint" || TableColumn.Data_type == "smallint")
                {
                    ...
                    TableColumn.Column_datatype_driver = "SqlDbType.Int";
                }
                ...
                else if (TableColumn.Data_type == "float")
                {
                    ...
                    TableColumn.Column_datatype_driver = "SqlDbType.Float";
                }
                ...
                else
                {
                    ...
                    TableColumn.Column_datatype_driver = "SqlDbType.VarChar";
                }
