...
{
    class Csharp_SQLITE_Generator : ILanguageModelGenerator
    {
        ...
        public string Get_GeneratedModel(TableDesign CurrentTableWithColumns, string ModelNameSpace = "swagfin.Models")
        {
            ...
            try
            {
                ...
                // #Determine Imports
                IMPORTS_STRING = "Imports System.Data.SQLite";
                ...
                ALLTEXT += Environment.NewLine + "Protected " + CurrentTableWithColumns.Db_connvariable + " As SQLiteConnection  = New SQLiteConnection(" + QuotesChar + "Data Source=" + CurrentTableWithColumns.Database_Name + ".db" + QuotesChar + ")";
        ...
        public string Generate_CREATE(TableDesign TableData)
        {
            ...
            try
            {
                ...
                string MYSQL_COMMAND_PARAMS = "Dim Command As New SQLiteCommand(Sql," + TableData.Db_connvariable + ")";
        ...
        public string Generate_DELETE(TableDesign TableData)
        {
            ...
            try
            {
                ...
                // #Execution
                FINALE_CREATE_STRING += Environment.NewLine + TableData.Db_connvariable + ".Open()";
                FINALE_CREATE_STRING += Environment.NewLine + "Dim Command As New SQLiteCommand(Sql," + TableData.Db_connvariable + ")";
        ...
        public string Generate_GET(TableDesign TableData)
        {
            ...
            try
            {
                ...
                FINALE_CREATE_STRING += Environment.NewLine + "Dim feedback As SQLiteDataReader = Command.ExecuteReader()";
                // #Fetch Details
        ...
        public string Generate_READ(TableDesign TableData)
        {
            ...
            try
            {
                ...
                FINALE_CREATE_STRING += Environment.NewLine + "Dim my_adapter As New SQLiteDataAdapter(Command)";
